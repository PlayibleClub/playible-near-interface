...
const gameInfo = [
  {
    ...
    isActive: true,
    description:
      'Go head-to-head with the best of the East. Select 5 players and create your fantasy lineup now.',
  },
  {
                      ...
                      <div className="mt-6">
                        <div className="flex flex-col md:flex-row justify-center md:justify-between">
                          ...
                          <div className="md:w-1/2 mt-8 md:mt-0">
                            <div className="font-thin">PRIZE POOL</div>

                            <div className="text-3xl">${data.prizePool}</div>

                            <div className="md:w-3/4 mt-8 font-thin mr-4">{data.description}</div>
                          </div>
                        </div>
