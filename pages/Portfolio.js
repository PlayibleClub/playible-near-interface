                                        ...
                                        <div className="rounded-md bg-indigo-light ml-1 h-11 w-9/12 flex">
                                            <div className="ml-1 mt-2">
                                                <form onSubmit={handleSubmit(onSubmit)}>
                                                    <input {...register("search")} className="text-xl ml-3 appearance-none bg-indigo-light focus:outline-none w-8/12" placeholder="Search..." />
                                                    <button className="w-3/12">
                                                        <input type="image" src={searchIcon} className="object-none ml-6"/>
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
