            ...
            <Main color="indigo-white">
              ...
              <div className="flex flex-col w-full hide-scroll overflow-x-hidden  h-full md:h-min self-center text-indigo-black relative">
                ...
                <div className={`${selectModal ? 'hidden h-0' : ''}`}>
                  <div className="md:ml-6 md:-mt-0 mt-20">
                    <PortfolioContainer title="CREATE LINEUP" textcolor="text-indigo-black" />
                  </div>
                  <div className="flex flex-col md:-mt-8 md:-mb-5">
                    <div className="flex items-end pt-7 ml-5 -mt-12 md:mt-0">
                      <div className="font-monument text-xl iphone5:ml-0 md:ml-6 truncate w-40 md:w-min md:max-w-xs">
                        {teamName}
                      </div>
                      <p
                        className="ml-12 underline text-sm pb-1 cursor-pointer"
                        onClick={() => setEditModal(true)}
                      >
                        EDIT TEAM NAME
                      </p>
                    </div>
                    <div className="grid grid-cols-4 md:gap-y-4 md:mt-16 iphone5:mt-0 mb-2 md:mb-10 md:grid-cols-4 md:mr-0">
                      {lineup.map((data, i) => {
                        console.log(lineup);
                        return (
                          <>
