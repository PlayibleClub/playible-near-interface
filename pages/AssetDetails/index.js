                          ...
                          (stats && assetData) ?
                            <div className="flex flex-col overflow-y-auto overflow-x-hidden">
                              <div className="md:ml-8">
                                <div className="mt-8">
                                  <BackFunction prev={query.origin.toLowerCase() === 'portfolio' ? "/Portfolio/" : "/Marketplace/"}/>
                                </div>
                                ...
                                <div className="mt-10 flex flex-col md:flex-row justify-between">
                                  <PortfolioContainer textcolor="indigo-black" title="PLAYER STATS" stats={String(stats.fantasy_score || 0)}/>
