    ...
    const getAthleteInfo = async () => {
      ...
      if (res.info  !== undefined) {
        setAssetData({
          ...res.info.extension,
          token_uri: img,
          token_uri_alt: res.info.token_uri
        })
      }
      if (playerStats) {
                    ...
                    {stats && assetData ? (
                      <div className="flex flex-col overflow-y-auto overflow-x-hidden">
                        <div className="md:ml-8">
                              ...
                              <div className="flex md:flex-row flex-col md:mt-8">
                                <div>
                                  <div className="ml-8 md:ml-6 mr-16">
                                    <PlayerContainer
                                      img={assetData.token_uri_alt || assetData.token_uri}
                          ...
                          <div className="text-indigo-white bg-indigo-black w-max px-5 py-4 text-3xl font-bold text-center ml-6 mt-8 md:mt-0 font-monument">
