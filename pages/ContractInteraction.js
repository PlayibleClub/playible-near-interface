...
const ContractInteraction = () => {
  ...
  const { status, network, wallets, availableConnectTypes, connect, disconnect, signBytes } =
    useWallet();
    ...
    <>
      ...
      <div className="flex flex-col p-4 max-w-md gap-1">
        {status === WalletStatus.WALLET_NOT_CONNECTED && (
          <button key={'connect-' + availableConnectTypes[1]} onClick={interactWallet}>
            Connect {availableConnectTypes[1]}
          </button>
        )}
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="executeMsg">
            ...
            <input
              id="executeMsg"
              type="text"
              placeholder="Enter Execute Message here"
              value={executeMsg}
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="coins">
            ...
            <input
              ...
              value={offeredCoin}
              onChange={(e) => setOfferedCoin(e.target.value)}
            />
          </label>
        </div>
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="codeID">
            ...
            <input
              id="codeID"
              type="text"
              placeholder="Enter Contract Code ID here"
              value={codeID}
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="initMsg">
            ...
            <input
              id="initMsg"
              type="text"
              placeholder="Enter Init Message here"
              value={initMsg}
          ...
          <label htmlFor="migratable">
            ...
            <form>
              <input
                ...
                value={true}
                name="migratable"
                onChange={(e) => setMigratable(e.target.value)}
              />
